...
<body class="easyui-layout" scroll="no">
    ...
    <form id="form1" >
        <div data-options="region:'north',border:false" id="north">
            <span class="topright">
                欢迎<span class="lgUser">您,${user.status}${teacher.teastatus}：${user.sname}${teacher.teaname}&nbsp; </span><a href="#" id="editpass">修改密码</a> <a href="./adminlogout.do" id="loginOut">安全退出</a></span>
